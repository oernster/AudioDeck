...
mean: that is how a go-ahead button on the uninstall screen kept the styling of
a safe action while doing a destructive one; it is also how a progress screen
...
class Footer(QWidget):
    ...
    def __init__(self, parent: QWidget) -> None:
        """Build the empty row the screens fill.

        Args:
            parent: The window the footer belongs to.
        """
        ...
        self._row.setSpacing(c.ACTION_SPACING)
    ...
    def show_actions(self, actions: Iterable[Action]) -> None:
        ...
        Args:
            actions: The buttons this screen offers, left to right.
        """
