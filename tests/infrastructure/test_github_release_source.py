"""Tests for the GitHub releases adapter, with an injected fake opener."""

import json

import pytest

from src.infrastructure.updates.github_release_source import (
    _ACCEPT_HEADER,
    _API_URL,
    _TIMEOUT_SECONDS,
    GitHubReleaseSource,
...
PAYLOAD = {
    "tag_name": "v1.5.0",
    "html_url": "https://github.com/oernster/AudioDeck/releases/tag/v1.5.0",
    "assets": [
        {
            "name": "AudioDeckSetup.exe",
            "browser_download_url": "https://example.com/AudioDeckSetup.exe",
        },
    ],
}
